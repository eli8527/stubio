---
title: White, Green, Black, Blue, Red, Yellow
date: 2018-12-11 09:06:21 +0000
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/c_all_3_9d5f46fe-332a-4eab-b3a3-6b94faa6bf42.jpg
description: <p>Measures 1.7". Clear ornament.</p><p>Marbled Ornaments is a collection
  of somewhat untraditional holiday ornaments. they are marbled by hand. while marbling
  is generally used for bookbinding, or on <a href="https://www.publicartfund.org/view/exhibitions/6640_tauba_auerbach_flow_separation">ships</a>,
  we choose to use this technique instead of the usual mass produced sparkles and
  colorful stripes. the design is entirely up to chance. or fluid dynamics, more so.
  you will find that each ornament is unique, with our only real intervention being
  the choice of colors.</p>
price: 5
buy_html: |-
  <div id='product-component-1544603438717'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1797192417344],
              node: document.getElementById('product-component-1544603438717'),
              moneyFormat: '${{amount}}',
