...
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/DSF2128.JPG
...
price: 28
buy_html: |-
  <div id='product-component-1545288070176'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1916928786496],
              node: document.getElementById('product-component-1545288070176'),
              moneyFormat: '${{amount}}',
