...
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/w_blue_1.jpg
...
price: 9
buy_html: |-
  <div id='product-component-1544573313627'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1791099371584],
              node: document.getElementById('product-component-1544573313627'),
              moneyFormat: '${{amount}}',
