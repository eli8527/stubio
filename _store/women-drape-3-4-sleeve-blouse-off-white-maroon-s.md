---
title: Women Drape 3/4 Sleeve Blouse Off White/Maroon (S)
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/DSF2133.JPG
...
price: 35
buy_html: |-
  <div id='product-component-1545288659106'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1917043802176],
              node: document.getElementById('product-component-1545288659106'),
              moneyFormat: '${{amount}}',
