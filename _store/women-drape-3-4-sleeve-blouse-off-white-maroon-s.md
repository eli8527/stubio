...
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/DSF2132.JPG
...
price: 35
buy_html: |-
  <div id='product-component-1545288859542'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1917103996992],
              node: document.getElementById('product-component-1545288859542'),
              moneyFormat: '${{amount}}',
