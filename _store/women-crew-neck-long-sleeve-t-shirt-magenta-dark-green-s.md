...
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/DSF2130.JPG
...
price: 28
buy_html: |-
  <div id='product-component-1545288363791'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1917008609344],
              node: document.getElementById('product-component-1545288363791'),
              moneyFormat: '${{amount}}',
