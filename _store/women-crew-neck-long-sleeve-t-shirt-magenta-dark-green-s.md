---
title: Women Crew Neck Long Sleeve T-Shirt Magenta/Dark Green (S)
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/DSF2129.JPG
...
price: 28
buy_html: |-
  <div id='product-component-1545288269646'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1916985802816],
              node: document.getElementById('product-component-1545288269646'),
              moneyFormat: '${{amount}}',
