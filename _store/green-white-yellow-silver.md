...
images:
- image_url: https://cdn.shopify.com/s/files/1/0100/8418/8224/products/s_green_white_yellow_1.jpg
...
price: 9
buy_html: |-
  <div id='product-component-1544601764550'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1796894130240],
              node: document.getElementById('product-component-1544601764550'),
              moneyFormat: '${{amount}}',
