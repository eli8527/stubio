---
title: Unique Clothes T-Shirt White/Navy (Unisex M)
...
price: 25
buy_html: |-
  <div id='product-component-1544513625105'></div>
        ...
        function ShopifyBuyInit() {
          ...
          ShopifyBuy.UI.onReady(client).then(function (ui) {
            ui.createComponent('product', {
              id: [1778050367552],
              node: document.getElementById('product-component-1544513625105'),
              moneyFormat: '${{amount}}',
